 ...
 *************************************************************************/
    ...
    public void visitTopLevel(JCCompilationUnit tree) {
        ...
        if (isPkgInfo) {
            Env<AttrContext> env0 = getTypeEnvs().get(tree.packge);
            if (env0 == null) {
                getTypeEnvs().put(tree.packge, topEnv);
            } else {
...
//      System.err.println("entering " + c.fullname + " in " + c.owner);//DEBUG
    ...
    // de.so.ma
	public Map<TypeSymbol,Env<AttrContext>> getTypeEnvs() {
		return typeEnvs;
	}
}
