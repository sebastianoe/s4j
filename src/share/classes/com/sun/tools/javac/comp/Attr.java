...
import de.so.ma.transformation.SqlQueryNodeTransformer;
...
public class Attr extends JCTree.Visitor {
    ...
    public Type attribType(JCTree node, TypeSymbol sym) {
        Env<AttrContext> env = enter.getTypeEnvs().get(sym);
 ...
 *************************************************************************/
    ...
    List<Type> attribArgs(List<JCExpression> trees, Env<AttrContext> env) {
        ...
        for (List<JCExpression> l = trees; l.nonEmpty(); l = l.tail) {
        	// de.so.ma
        	l.head = SqlQueryNodeTransformer.getInstance()
            		.transformPotentialSqlQuery(l.head, env, Infer.anyPoly, this, enter, memberEnter);
    ...
    public void visitExec(JCExpressionStatement tree) {
        ...
        tree.expr = transformer.transformPotentialSqlQuery(
        		tree.expr, localEnv, null, this, enter, memberEnter);
    ...
    public void visitAssign(JCAssign tree) {
        ...
        tree.rhs = SqlQueryNodeTransformer.getInstance()
        		.transformPotentialSqlQuery(tree.rhs, env, owntype, this, enter, memberEnter);
    ...
    public void visitBinary(JCBinary tree) {
    	...
    	// de.so.ma
    	SqlQueryNodeTransformer transformer = SqlQueryNodeTransformer.getInstance();
    	tree.lhs = transformer.transformPotentialSqlQuery(
    			tree.lhs, env, Type.noType, this, enter, memberEnter);
    	tree.rhs = transformer.transformPotentialSqlQuery(
    			tree.rhs, env, Type.noType, this, enter, memberEnter);
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    void attribClass(ClassSymbol c) throws CompletionFailure {
        ...
        if ((c.flags_field & UNATTRIBUTED) != 0) {
            ...
            Env<AttrContext> env = enter.getTypeEnvs().get(c);
