...
public class Context {
    ...
    public <T> void put(Key<T> key, T data) {
        ...
        // de.so.ma
        /*
        IMPORTANT: commented out the following lines due to an AssertionError that occured 
        when generating the additional compilation unit files.
        Calling context.get(JavaFileObject.class) from the AdditionalFilesManager somehow
        influenced the print writer (only when using the tool javac!), espc. it's (this) 
        put method.
        */
